...
public class GenericNodeTest
{
  ...
  public void testSynchingLogic() throws InterruptedException
  {
    ...
    gn.setId(1);
    ForwardingReservoir reservoir1 = new ForwardingReservoir(AbstractReservoir.newReservoir("ip1Res", 1024));
    ForwardingReservoir reservoir2 = new ForwardingReservoir(AbstractReservoir.newReservoir("ip2Res", 1024));
